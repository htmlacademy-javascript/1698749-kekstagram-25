...
const addEscHandler = function (el) {
...
const expandPicture = function (el) {
...
const addClickHandler = function (el) {
...
currentPictures.forEach((item) => {item.addEventListener ('click', () => {
